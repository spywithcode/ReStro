    ...
    const menuItemsData = [
      {
        ...
        imageUrl: 'https://placehold.co/600x400?text=Butter+Chicken',
        isAvailable: true,
        restaurantId
      },
      {
        ...
        price: 80,
        category: 'Appetizer',
        imageUrl: 'https://placehold.co/600x400?text=Naan+Bread',
        isAvailable: true,
        restaurantId
      },
      {
        ...
        price: 120,
        category: 'Dessert',
        imageUrl: 'https://placehold.co/600x400?text=Gulab+Jamun',
        isAvailable: true,
        restaurantId
      },
      {
